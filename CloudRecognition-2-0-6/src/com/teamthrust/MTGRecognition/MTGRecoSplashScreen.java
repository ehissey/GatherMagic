...
@file
    MTGRecoSplashScreen.java

@brief
    Splash screen Activity for the MTGReco sample application
...
public class MTGRecoSplashScreen extends Activity
{
    public void onCreate(Bundle savedInstanceState)
    {
        ...
        handler.postDelayed(new Runnable()
        {
            public void run()
            {
                ...
                startActivity(new Intent(MTGRecoSplashScreen.this,
                        MTGReco.class));
            }
        }, 2000L);
    }
