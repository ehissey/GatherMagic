...
// ----------------------------------------------------------------------------
class MTGReco_UpdateCallback : public QCAR::UpdateCallback
{
...
MTGReco_UpdateCallback updateCallback;
...
Java_com_teamthrust_MTGRecognition_MTGReco_setActivityPortraitMode(JNIEnv *, jobject, jboolean isPortrait)
{
...
Java_com_teamthrust_MTGRecognition_MTGReco_initTracker(JNIEnv *, jobject)
{
...
// ----------------------------------------------------------------------------
JNIEXPORT void JNICALL
Java_com_teamthrust_MTGRecognition_MTGReco_deinitTracker(JNIEnv *, jobject)
{
...
// ----------------------------------------------------------------------------
JNIEXPORT int JNICALL
Java_com_teamthrust_MTGRecognition_MTGReco_initMTGReco(JNIEnv *, jobject)
{
...
// ----------------------------------------------------------------------------
// DeInitialize MTG Reco
// ----------------------------------------------------------------------------
JNIEXPORT int JNICALL
Java_com_teamthrust_MTGRecognition_MTGReco_deinitMTGReco(JNIEnv *, jobject)
{
    // Get the image tracker:
    QCAR::TrackerManager& trackerManager = QCAR::TrackerManager::getInstance();
    QCAR::ImageTracker* imageTracker = static_cast<QCAR::ImageTracker*>(
...
// ----------------------------------------------------------------------------
JNIEXPORT void JNICALL
Java_com_teamthrust_MTGRecognition_MTGReco_productTextureIsCreated(JNIEnv *env,jobject)
{
...
// ----------------------------------------------------------------------------
JNIEXPORT void JNICALL
Java_com_teamthrust_MTGRecognition_MTGRecoRenderer_renderFrame(JNIEnv *, jobject)
{
...
// ----------------------------------------------------------------------------
JNIEXPORT void JNICALL
Java_com_teamthrust_MTGRecognition_MTGReco_initApplicationNative(
        JNIEnv* env, jobject obj, jint width, jint height)
{
    ...
    getProductTextureID = env->GetMethodID(activityClass, "getProductTexture", "()Lcom/teamthrust/MTGRecognition/Texture;");
...
// ----------------------------------------------------------------------------
JNIEXPORT void JNICALL
Java_com_teamthrust_MTGRecognition_MTGReco_deinitApplicationNative(
...
// ----------------------------------------------------------------------------
JNIEXPORT void JNICALL
Java_com_teamthrust_MTGRecognition_MTGReco_startCamera(JNIEnv *, jobject)
{
...
// ----------------------------------------------------------------------------
JNIEXPORT void JNICALL
Java_com_teamthrust_MTGRecognition_MTGReco_stopCamera(JNIEnv *,jobject)
{
    // Stop the tracker:
    QCAR::TrackerManager& trackerManager = QCAR::TrackerManager::getInstance();
    QCAR::ImageTracker* imageTracker = static_cast<QCAR::ImageTracker*>(
...
// ----------------------------------------------------------------------------
JNIEXPORT void JNICALL
Java_com_teamthrust_MTGRecognition_MTGReco_setProjectionMatrix(JNIEnv *, jobject)
{
...
// ----------------------------------------------------------------------------
// Chceks if MTGReco functionality is started
// ----------------------------------------------------------------------------
JNIEXPORT jboolean JNICALL
Java_com_teamthrust_MTGRecognition_MTGReco_isMTGRecoStarted(JNIEnv*, jobject)
{
    return crStarted;
}
...
// ----------------------------------------------------------------------------
JNIEXPORT jboolean JNICALL
Java_com_teamthrust_MTGRecognition_MTGReco_activateFlash(JNIEnv*, jobject, jboolean flash)
{
...
// ----------------------------------------------------------------------------
JNIEXPORT jboolean JNICALL
Java_com_teamthrust_MTGRecognition_MTGReco_autofocus(JNIEnv*, jobject)
{
...
// ----------------------------------------------------------------------------
JNIEXPORT jboolean JNICALL
Java_com_teamthrust_MTGRecognition_MTGReco_setFocusMode(JNIEnv*, jobject, jint mode)
{
    int qcarFocusMode;
...
// ----------------------------------------------------------------------------
JNIEXPORT void JNICALL
Java_com_teamthrust_MTGRecognition_MTGRecoRenderer_initRendering(
        JNIEnv* env, jobject obj)
{
    // Define clear color
...
// ----------------------------------------------------------------------------
JNIEXPORT void JNICALL
Java_com_teamthrust_MTGRecognition_MTGRecoRenderer_updateRendering(
        JNIEnv* env, jobject obj, jint width, jint height)
{
...
// ----------------------------------------------------------------------------
JNIEXPORT void JNICALL
Java_com_teamthrust_MTGRecognition_MTGReco_finishTransition(JNIEnv* env, jobject obj)
{
...
// ----------------------------------------------------------------------------
// Disables the MTGReco service
// ----------------------------------------------------------------------------
JNIEXPORT void JNICALL
Java_com_teamthrust_MTGRecognition_MTGReco_enterContentModeNative(JNIEnv*, jobject)
{
    QCAR::TrackerManager& trackerManager = QCAR::TrackerManager::getInstance();
    QCAR::ImageTracker* imageTracker = static_cast<QCAR::ImageTracker*>(
            trackerManager.getTracker(QCAR::Tracker::IMAGE_TRACKER));
...
// ----------------------------------------------------------------------------
// Enables MTGReco Service
// ----------------------------------------------------------------------------
JNIEXPORT void JNICALL
Java_com_teamthrust_MTGRecognition_MTGReco_enterScanningModeNative(JNIEnv*, jobject)
{
    QCAR::TrackerManager& trackerManager = QCAR::TrackerManager::getInstance();
    QCAR::ImageTracker* imageTracker = static_cast<QCAR::ImageTracker*>(
            trackerManager.getTracker(QCAR::Tracker::IMAGE_TRACKER));
...
// ----------------------------------------------------------------------------
JNIEXPORT void JNICALL
Java_com_teamthrust_MTGRecognition_MTGReco_setDeviceDPIScaleFactor(JNIEnv*, jobject, jfloat dpiSIndicator)
{
...
// ----------------------------------------------------------------------------
JNIEXPORT void JNICALL
Java_com_teamthrust_MTGRecognition_MTGReco_cleanTargetTrackedId(JNIEnv*, jobject)
{
    pthread_mutex_lock(&lastTargetIdMutex);
    lastTargetId[0] = '\0';
    pthread_mutex_unlock(&lastTargetIdMutex);
...
renderAugmentation(const QCAR::TrackableResult* trackableResult)
{
    ...
    SampleUtils::checkGlError("MTGReco renderFrame");
}
